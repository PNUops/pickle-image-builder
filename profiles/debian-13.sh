...
# Debian 13 (Trixie). Sourced by scripts/build.sh.
#
...
# Debian 13 mounts /tmp as a tmpfs sized at half of RAM. On the 1 GiB guests this
# platform hands out, a student extracting a large archive into /tmp spends real
# memory and gets the process killed, while df reports gigabytes of free disk;
# nothing in that failure names /tmp. Debian 12 has no such unit and needs no
# equivalent.
TMP_ON_DISK=yes
